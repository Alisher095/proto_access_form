...
<body data-user-role="<?php echo htmlspecialchars($userRole); ?>">
  ...
  <nav class="navbar navbar-expand-lg bg-white border-bottom">
    <div class="container">
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <span class="badge text-bg-light border"><?php echo htmlspecialchars(ucfirst($userRole)); ?></span>
  ...
  <main id="main" class="container my-4">
    ...
    <section class="row g-4">
      ...
      <div class="col-lg-2">
        <div class="panel ai-panel" data-ai-assistant>
          <h5>AI Assistant</h5>
          <p class="text-muted small mb-2">Optional helper for Creator role.</p>
          <div class="mb-2">
            <label class="form-label small" for="aiTopic">Topic</label>
            <input id="aiTopic" class="form-control form-control-sm" type="text" placeholder="e.g. Student feedback" data-ai-topic />
          </div>
          <div class="d-grid gap-2">
            <button type="button" class="btn btn-sm btn-outline-primary" data-ai-generate-meta>Generate title/description</button>
            <button type="button" class="btn btn-sm btn-outline-primary" data-ai-suggest-fields>Suggest fields</button>
            <button type="button" class="btn btn-sm btn-outline-secondary" data-ai-check-a11y>Accessibility check</button>
          </div>
          <div class="ai-status mt-2 small" data-ai-status aria-live="polite"></div>
          <div class="ai-results mt-2" data-ai-results></div>
        </div>
      </div>
    </section>
  </main>
